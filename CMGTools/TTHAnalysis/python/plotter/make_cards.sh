...
if [[ "$1" == "" ]] || echo $1 | grep -q 2lss; then
    OPTIONS="${OPTIONS} -F sf/t /afs/cern.ch/work/c/cirkovic/Milos_08-10-2014/CMSSW_7_0_6_patch1/src/CMGTools/TTHAnalysis/macros/OUTPUT_081014_203308/evVarFriend_{cname}.root --FM sf/t /afs/cern.ch/work/c/cirkovic/Milos_08-10-2014/CMSSW_7_0_6_patch1/src/CMGTools/TTHAnalysis/macros/OUTPUT_SF_091014_004855/sfFriend_{cname}.root "
    OPT_2L="${OPTIONS} -W puWeight*SF_LepMVATight_2l*SF_LepTightCharge_2l "
    MVA_2L=" -F sf/t /afs/cern.ch/work/c/cirkovic/Milos_08-10-2014/CMSSW_7_0_6_patch1/src/CMGTools/TTHAnalysis/macros/OUTPUT_1_081014_220825/evVarFriend_{cname}.root "
