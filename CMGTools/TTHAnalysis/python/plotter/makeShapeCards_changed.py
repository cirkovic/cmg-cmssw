...
def file2map(x):
    ...
    return ret
YRpath = "/afs/cern.ch/work/c/cirkovic/Milos_26-10-2014/CMSSW_6_1_1/src/HiggsAnalysis/CombinedLimit/data/lhc-hxswg/sm/";
...
#    y = { "hww": ROOT.std.vector('double')(), "hzz": ROOT.std.vector('double')(), "htt": ROOT.std.vector('double')() }
    y = { "hww": ROOT.std.vector('double')(), "htt": ROOT.std.vector('double')() }
...
#        for p in "ttH_hww ttH_hzz ttH_htt".split():
        for p in "ttH_hww ttH_htt".split():
