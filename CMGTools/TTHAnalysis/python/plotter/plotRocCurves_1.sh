...
case $1 in
   1 )
		python rocCurves.py -P /afs/cern.ch/work/c/cirkovic/TREES_53X_170714_1 -j 6 -f -l 19.6 mca_sh.txt bins/2lss_mumu.txt roc_2lss_mumu.txt -o OT_roc_mumu -F sf/t /afs/cern.ch/work/c/cirkovic/Milos_13-08-2014/31-08-2014/2/1/evVarFriend_{cname}.root -F sf/t /afs/cern.ch/work/c/cirkovic/Milos_13-08-2014/31-08-2014/2/3/evVarFriend_{cname}.root --FM sf/t /afs/cern.ch/work/c/cirkovic/Milos_13-08-2014/31-08-2014/2/4/sfFriend_{cname}.root -W 'puWeight*LepEff_2lep' -p 'TTW,TT' --sp 'TTW' -X 'lep MVA' --tree treeProducerSusyMultilepton --s2v
		mv OT_roc_mumu.png /afs/cern.ch/work/c/cirkovic/Milos_13-08-2014/31-08-2014/2/5/1
		rm OT_roc_mumu
		;;
	2 )
		python rocCurves.py -P /afs/cern.ch/work/c/cirkovic/TREES_53X_170714_1 -j 6 -f -l 19.6 mca_sh.txt bins/2lss_em.txt roc_2lss_em.txt -o OT_roc_em -F sf/t /afs/cern.ch/work/c/cirkovic/Milos_13-08-2014/31-08-2014/2/1/evVarFriend_{cname}.root -F sf/t /afs/cern.ch/work/c/cirkovic/Milos_13-08-2014/31-08-2014/2/3/evVarFriend_{cname}.root --FM sf/t /afs/cern.ch/work/c/cirkovic/Milos_13-08-2014/31-08-2014/2/4/sfFriend_{cname}.root -W 'puWeight*LepEff_2lep' -p 'TTW,TT' --sp 'TTW' -X 'lep MVA' --tree treeProducerSusyMultilepton --s2v
		mv OT_roc_em.png /afs/cern.ch/work/c/cirkovic/Milos_13-08-2014/31-08-2014/2/5/2
		rm OT_roc_em
		;;
	3 )
		python rocCurves.py -P /afs/cern.ch/work/c/cirkovic/TREES_53X_170714_1 -j 6 -f -l 19.6 mca_sh.txt bins/2lss_ee.txt roc_2lss_ee.txt -o OT_roc_ee -F sf/t /afs/cern.ch/work/c/cirkovic/Milos_13-08-2014/31-08-2014/2/1/evVarFriend_{cname}.root -F sf/t /afs/cern.ch/work/c/cirkovic/Milos_13-08-2014/31-08-2014/2/3/evVarFriend_{cname}.root --FM sf/t /afs/cern.ch/work/c/cirkovic/Milos_13-08-2014/31-08-2014/2/4/sfFriend_{cname}.root -W 'puWeight*LepEff_2lep' -p 'TTW,TT' --sp 'TTW' -X 'lep MVA' --tree treeProducerSusyMultilepton --s2v
		mv OT_roc_ee.png /afs/cern.ch/work/c/cirkovic/Milos_13-08-2014/31-08-2014/2/5/3
		rm OT_roc_ee
		;;
	4 )
