...
combineCards.py .=2lss_MVA.card.txt  tl=3l_MVA.card.txt  ql=4l_nJet.card.txt > comb_MVA.card.txt
    ...
    combineCards.py ss_ee=ttH_2lss_eeBCat_QMVA.card.txt   \
                    ss_mumu=ttH_2lss_mumuBCat_QMVA.card.txt \
                    ss_em=ttH_2lss_emBCat_QMVA.card.txt     > ttH_2lssBCat_QMVA.card.txt
