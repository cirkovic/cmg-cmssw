...
class LepGoodInds:
    ...
    def listBranches(self):
        ...
        return [ ("nLepGood","I"), ("LepGood_indices","I",8,"nLepGood") ]
    def __call__(self,event):
        lep = Collection(event,"LepGood","nLepGood",8)
        ret = { 'nLepGood' : event.nLepGood }
        if event.run >= 1: # DATA
            ret['LepGood_indices'] = [ i for i in xrange(len(lep)) ] 
        else:              # MC
            ret['LepGood_indices'] = [ i for i in xrange(len(lep)) ] 
        return ret
...
if __name__ == '__main__':
    ...
    class Tester(Module):
        def __init__(self, name):
            ...
            self.mvas = {
                'old': LepGoodInds(("/afs/cern.ch/work/g/gpetrucc/CMSSW_7_4_7/src/CMGTools/TTHAnalysis/data/leptonMVA/tth/%s_BDTG.weights.xml",
                                     "/afs/cern.ch/work/g/gpetrucc/CMSSW_7_4_7/src/CMGTools/TTHAnalysis/data/leptonMVA/tth/%s_BDTG.weights.xml",)),
                'v2' : LepGoodInds(("/afs/cern.ch/work/g/gpetrucc/CMSSW_7_4_7/src/CMGTools/TTHAnalysis/macros/leptons/weights/%s_v2_BDTG.weights.xml",
                                     "/afs/cern.ch/work/g/gpetrucc/CMSSW_7_4_7/src/CMGTools/TTHAnalysis/macros/leptons/weights/%s_v2_BDTG.weights.xml",),
                                    training="v2"),
                'withpt' : LepGoodInds(("/afs/cern.ch/work/g/gpetrucc/CMSSW_7_4_7/src/CMGTools/TTHAnalysis/macros/leptons/weights/%s_withpt_BDTG.weights.xml",
                                         "/afs/cern.ch/work/g/gpetrucc/CMSSW_7_4_7/src/CMGTools/TTHAnalysis/macros/leptons/weights/%s_withpt_BDTG.weights.xml",),
                                        training="withpt"),
                'withpt_v2' : LepGoodInds(("/afs/cern.ch/work/g/gpetrucc/CMSSW_7_4_7/src/CMGTools/TTHAnalysis/macros/leptons/weights/%s_withpt_v2_BDTG.weights.xml",
                                            "/afs/cern.ch/work/g/gpetrucc/CMSSW_7_4_7/src/CMGTools/TTHAnalysis/macros/leptons/weights/%s_withpt_v2_BDTG.weights.xml",),
                                           training="withpt_v2"),
                'withpt_v2_w05' : LepGoodInds(("/afs/cern.ch/work/g/gpetrucc/CMSSW_7_4_7/src/CMGTools/TTHAnalysis/macros/leptons/weights/%s_withpt_v2_w05_BDTG.weights.xml",
