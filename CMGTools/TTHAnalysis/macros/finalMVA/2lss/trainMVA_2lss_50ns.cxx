void trainMVA_2lss_50ns(TString name) {
    ...
    tSig->AddFriend("sf/t", "/afs/cern.ch/work/c/cirkovic/Milos_02-10-2014/CMSSW_7_0_6_patch1/src/CMGTools/TTHAnalysis/macros/FT_OUTPUT_021014_151628/evVarFriend_TTHnlo_S14.root");
    ...
    if (name.Contains("ttW")) {
        ...
        TTree *tBkg = (TTree *) fBkg->Get("treeProducerSusyMultilepton");
        tBkg->AddFriend("sf/t", "/afs/cern.ch/work/c/cirkovic/Milos_02-10-2014/CMSSW_7_0_6_patch1/src/CMGTools/TTHAnalysis/macros/FT_OUTPUT_021014_151628/evVarFriend_TTJets_PUS14.root");
        factory->AddBackgroundTree(tBkg, 1.0);
