void trainMVA_2lss_6VAR(TString name) {
    ...
    tSig->AddFriend("ttHLepTreeProducerBase/t", "/afs/cern.ch/work/c/cirkovic/Milos_24-08-2014/26-08-2014/1/1/evVarFriend_TTH122.root");
    ...
    tSig->AddFriend("ttHLepTreeProducerBase/t", "/afs/cern.ch/work/c/cirkovic/Milos_24-08-2014/26-08-2014/1/1/evVarFriend_TTH127.root");
    factory->AddSignalTree(tSig, 1.0);
...
//    factory->AddSignalTree(tSig, 1.0);
    ...
    if (name.Contains("ttW")) {
		...
		tBkg->AddFriend("ttHLepTreeProducerBase/t", "/afs/cern.ch/work/c/cirkovic/Milos_24-08-2014/26-08-2014/1/1/evVarFriend_TTWJets.root");
        ...
        TTree *tBkg = (TTree *) fBkg->Get("ttHLepTreeProducerBase");
        tBkg->AddFriend("ttHLepTreeProducerBase/t", "/afs/cern.ch/work/c/cirkovic/Milos_24-08-2014/26-08-2014/1/1/evVarFriend_TTJets.root");
        factory->AddBackgroundTree(tBkg, 1.0);
        ...
        tBkg1->AddFriend("ttHLepTreeProducerBase/t", "/afs/cern.ch/work/c/cirkovic/Milos_24-08-2014/26-08-2014/1/1/evVarFriend_TTJets.root");
        ...
        tBkg2->AddFriend("ttHLepTreeProducerBase/t", "/afs/cern.ch/work/c/cirkovic/Milos_24-08-2014/26-08-2014/1/1/evVarFriend_TTWJets.root");
    ...
    factory->AddVariable("LepGood2_pt := LepGood2_pt", 'F'), 		//bad
    factory->AddVariable("mhtJet25 : = mhtJet25", 'F'),			//bad
    factory->AddVariable("mindr_lep2_jet : = mindr_lep2_jet", 'F'),	//good
    factory->AddVariable("MT_met_lep1 : = MT_met_lep1", 'F'),		//bad
    factory->AddVariable("htJet25 : = htJet25", 'F');			//good
