void trainMVA_2lss(TString name) {
    ...
    tSig->AddFriend("sf/t", "/afs/cern.ch/work/c/cirkovic/Categorization_240914/CMSSW_5_3_19/src/CMGTools/TTHAnalysis/macros/FT_OUTPUT_240914_170333/evVarFriend_TTH122.root");
    ...
    tSig->AddFriend("sf/t", "/afs/cern.ch/work/c/cirkovic/Categorization_240914/CMSSW_5_3_19/src/CMGTools/TTHAnalysis/macros/FT_OUTPUT_240914_170333/evVarFriend_TTH127.root");
    factory->AddSignalTree(tSig, 1.0);

//    fSig = TFile::Open(Path+"/TTH/ttHLepTreeProducerBase/ttHLepTreeProducerBase_tree.root");
//    tSig = (TTree *) fSig->Get("ttHLepTreeProducerBase");
//    tSig->AddFriend("sf/t", Path+"/1_finalmva_3l_all_vars/evVarFriend_TTH.root");
//    factory->AddSignalTree(tSig, 1.0);
    ...
    if (name.Contains("ttW")) {
        ...
        tBkg->AddFriend("sf/t", "/afs/cern.ch/work/c/cirkovic/Categorization_240914/CMSSW_5_3_19/src/CMGTools/TTHAnalysis/macros/FT_OUTPUT_240914_170333/evVarFriend_TTJetsSem.root");
        factory->AddBackgroundTree(tBkg, 1.0);	
